...
using Tyuiu.PustobaevDO.Sprint0.Task7.V0.Lib;


namespace Tyuiu.PustobaevDO.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Пустобаев Д.О. | ИСПб-23-1";
            ...
            Console.WriteLine("* Выполнил Пустобаев Д.О. | ИСПб-23-1                                     *");
            Console.WriteLine("***************************************************************************");
